...
exports.proveedoresControler = void 0;
...
class proveedoresController {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.query("INSERT INTO provedor set ?", [req.body], (err, result, fields) => {
                if (err) {
                    throw err;
                }
...
exports.proveedoresControler = new proveedoresController();
